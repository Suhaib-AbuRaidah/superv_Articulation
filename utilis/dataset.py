...
class CustomDataset(Dataset):
    def __init__(self, pairs_root_dir, transform=None, target_transform=None):
        ...
        for file in files:
            ...
            data_tuples = (pc_start, pc_target, start_masks, target_masks, sdf_start, sdf_target, filtered_correspondences)
    ...
    def __getitem__(self,idx):
        ...
        return pc_start, pc_target, masks_start, masks_target, sdf_start, sdf_target, corresp_start, corresp_target
