...
def apply_inference(checkpoint_path):
    ...
    target_idx = 1  # you can also manually set the index here
    with torch.no_grad():
...
if __name__ == "__main__":
    chk = os.path.expanduser("~/superv_Articulation/pre_trained_models_gcnpp/2026-02-18 17:10:53_C/chkpt_best_model_train.pth")
    apply_inference(chk)